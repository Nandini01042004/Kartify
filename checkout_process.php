    ...
    if(mysqli_query($con,$sql)){
        ...
        while($i<=$total_count){
            ...
            if(mysqli_query($con,$sql1)){
                $trx_id = bin2hex(openssl_random_pseudo_bytes(10));
    
                $sql = "INSERT INTO orders (user_id,product_id,qty,trx_id,p_status) VALUES ('$user_id','".$prod_id."','".$prod_qty."','$trx_id','Completed')";
